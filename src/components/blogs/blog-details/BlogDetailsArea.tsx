...
const content_data: ContentData = {
   ...
   desc_9: (<>The Founder and Creative Director of vectorium, a digital creative studio in USA, has over 15 years of experience as an award-winning Creative Director/Art for clients.</>),
